...
```
   <a>
     <img src="https://github.com/GabrielVZanata/pyTensileTest/blob/main/Amostras de 16mm.png" alt="Group plot" width=400 height=300>
   </a>
...
This code was developed by Gabriel Valverde Zanata da Silva, a former student at the Polytechnic School of the University of São Paulo, to facilitate the manipulation and analysis of test data from the Shimadzu universal testing machine.
